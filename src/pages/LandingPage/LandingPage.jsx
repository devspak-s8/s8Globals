...
export default function LandingPage() {
  ...
  const techStack = ["React", "Python", "Node.js", "Tailwind CSS", "AI APIs", "Vercel", "Firebase"]

  const features = [
    { icon: <Code className="w-6 h-6" />, title: "Products", desc: "S8Academy, S8Builder, LexiAI" },
    { icon: <Globe className="w-6 h-6" />, title: "Platform", desc: "Web-first, responsive, scalable" },
    { icon: <Users className="w-6 h-6" />, title: "Target", desc: "Students, freelancers, creators" },
    { icon: <Palette className="w-6 h-6" />, title: "Focus", desc: "Education, Design, Development" },
  ]

  const stats = [
    { icon: <Users className="w-8 h-8" />, number: "10,000+", label: "Active Users" },
    { icon: <Target className="w-8 h-8" />, number: "500+", label: "Projects Launched" },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-hidden">
      ...
      {/* Navigation */}
      <nav
        className={`fixed top-0 w-full z-50 bg-slate-900/80 backdrop-blur-md border-b border-slate-800 transition-all duration-1000 ${isVisible ? "translate-y-0 opacity-100" : "-translate-y-full opacity-0"}`}
      >
        ...
        <div className="container mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-slate-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              From learning to launching — S8Globals empowers the next generation of learners, creators, and
              entrepreneurs with cutting-edge digital tools.
            </p>
          ...
          {/* Floating Animation */}
          <div
            className={`mt-16 transition-all duration-2000 delay-700 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
          >
      ...
      <section className="py-16 px-6" data-animate id="stats">
        <div className="container mx-auto">
          <div
            className={`grid grid-cols-2 md:grid-cols-4 gap-8 transition-all duration-1000 ${isAnimated("stats") ? "translate-y-0 opacity-100" : "translate-y-20 opacity-0"}`}
          >
            {stats.map((stat, index) => (
              <div
                key={index}
                className={`text-center transform transition-all duration-700 delay-${index * 100} ${isAnimated("stats") ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
              >
      ...
      <section id="products" className="py-20 px-6" data-animate>
        <div className="container mx-auto">
          <div
            className={`text-center mb-16 transition-all duration-1000 ${isAnimated("products") ? "translate-y-0 opacity-100" : "translate-y-20 opacity-0"}`}
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">
              Our Product Ecosystem
            </h2>
            <p className="text-xl text-slate-300 max-w-2xl mx-auto">
              Three powerful platforms working together to support your digital journey
            </p>
          </div>
            ...
            {products.map((product, index) => (
              ...
              >
                <CardHeader>
                  ...
                  <CardDescription className="text-slate-300 text-base">{product.description}</CardDescription>
                </CardHeader>
                <CardContent>
      ...
      {/* CTA Section 1 */}
      <section className="py-16 px-6 bg-gradient-to-r from-cyan-900/20 to-purple-900/20" data-animate id="cta1">
        <div className="container mx-auto text-center">
          <div
            className={`transition-all duration-1000 ${isAnimated("cta1") ? "translate-y-0 opacity-100" : "translate-y-20 opacity-0"}`}
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white">Ready to Transform Your Digital Journey?</h2>
            <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
              Join thousands of creators who are already building the future with S8Globals
            </p>
            <Button
              size="lg"
              className="bg-gradient-to-r from-cyan-500 to-purple-500 hover:from-cyan-600 hover:to-purple-600 text-lg px-8 py-3 transform hover:scale-105 transition-all duration-300"
      ...
      <section id="vision" className="py-20 px-6 bg-slate-800/30" data-animate>
        <div className="container mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div
              className={`transition-all duration-1000 ${isAnimated("vision") ? "translate-x-0 opacity-100" : "-translate-x-20 opacity-0"}`}
            >
              ...
              <p className="text-xl text-slate-300 mb-8 leading-relaxed">
                We're building an all-in-one ecosystem that supports learning, innovation, and growth for the future. No
                matter your level or location, our tools are designed to help you learn, build, and grow.
              </p>
              <div className="flex items-center space-x-4 mb-6">
                <Star className="w-6 h-6 text-yellow-400" />
                <span className="text-slate-300">Trusted by 10,000+ creators worldwide</span>
              </div>
            ...
            <div
              className={`grid grid-cols-2 gap-4 transition-all duration-1000 delay-300 ${isAnimated("vision") ? "translate-x-0 opacity-100" : "translate-x-20 opacity-0"}`}
            >
              {features.map((feature, index) => (
                <Card
                  key={index}
                  className={`bg-slate-800/50 border-slate-700 hover:border-slate-600 transition-all duration-500 hover:scale-105 transform delay-${index * 100}`}
                >
      ...
      <section className="py-20 px-6" data-animate id="tech">
        <div className="container mx-auto text-center">
          <div
            className={`transition-all duration-1000 ${isAnimated("tech") ? "translate-y-0 opacity-100" : "translate-y-20 opacity-0"}`}
          >
      ...
      {/* CTA Section 2 */}
      <section className="py-16 px-6 bg-gradient-to-r from-purple-900/20 to-pink-900/20" data-animate id="cta2">
        <div className="container mx-auto text-center">
          <div
            className={`transition-all duration-1000 ${isAnimated("cta2") ? "scale-100 opacity-100" : "scale-95 opacity-0"}`}
          >
            <Shield className="w-16 h-16 mx-auto mb-6 text-green-400" />
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white">Secure, Scalable, and Reliable</h2>
            <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
              Enterprise-grade security with 99.9% uptime guarantee. Your data and projects are always safe with us.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
      ...
      <section id="contact" className="py-20 px-6" data-animate>
        <div className="container mx-auto">
          <div
            className={`text-center mb-16 transition-all duration-1000 ${isAnimated("contact") ? "translate-y-0 opacity-100" : "translate-y-20 opacity-0"}`}
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">
              Get in Touch
            </h2>
            <p className="text-xl text-slate-300 max-w-2xl mx-auto">
              Ready to start your journey? We'd love to hear from you. Send us a message and we'll respond as soon as
              possible.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            {/* Contact Form */}
            <Card
              className={`bg-slate-800/50 border-slate-700 transition-all duration-1000 delay-200 ${isAnimated("contact") ? "translate-x-0 opacity-100" : "-translate-x-20 opacity-0"}`}
            >
              <CardHeader>
            ...
            {/* Contact Information */}
            <div
              className={`space-y-8 transition-all duration-1000 delay-400 ${isAnimated("contact") ? "translate-x-0 opacity-100" : "translate-x-20 opacity-0"}`}
            >
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-300">hello@s8globals.com</p>
                      <p className="text-slate-300">support@s8globals.com</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
              ...
              <Card className="bg-gradient-to-r from-cyan-900/20 to-purple-900/20 border-slate-700">
                <CardContent className="p-6">
                  <h4 className="font-semibold text-white mb-3">Quick Response Guarantee</h4>
                  <p className="text-slate-300 text-sm mb-4">
                    We typically respond to all inquiries within 2-4 hours during business hours.
                  </p>
                  <div className="flex items-center space-x-2">
                    <Clock className="w-4 h-4 text-green-400" />
                    <span className="text-green-400 text-sm font-medium">Average response time: 1.5 hours</span>
                  </div>
                </CardContent>
              </Card>
            </div>
      ...
      {/* Final CTA Section */}
      <section className="py-20 px-6 bg-gradient-to-r from-cyan-900/20 to-purple-900/20" data-animate id="final-cta">
        <div className="container mx-auto text-center">
          <div
            className={`transition-all duration-1000 ${isAnimated("final-cta") ? "translate-y-0 opacity-100" : "translate-y-20 opacity-0"}`}
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">
              Ready to Join the
              <span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
              Start your journey with S8Globals today. Learn, build, and grow with our comprehensive digital ecosystem.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
      ...
      {/* Footer */}
      <footer className="py-12 px-6 border-t border-slate-800" data-animate id="footer">
        <div className="container mx-auto">
          <div
            className={`grid md:grid-cols-4 gap-8 transition-all duration-1000 ${isAnimated("footer") ? "translate-y-0 opacity-100" : "translate-y-20 opacity-0"}`}
          >
            <div>
              <div className="text-2xl font-bold bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent mb-4">
                S8Globals
              </div>
              <p className="text-slate-400 mb-4">Your all-in-one digital ecosystem — from learning to launching.</p>
